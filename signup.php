...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,email,btc_address,password,contactno) values('$fname','$lname','$email','$btc_address','$password','$contact')");
...
<div class="form-floating mb-3">
<input class="form-control" id="email" name="btc_address" type="text" placeholder="phpgurukulteam@gmail.com" required />
